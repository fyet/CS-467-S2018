...
<?php 
  ...
  if($_SESSION['accountType'] == "standard"){
    ...
    header("Location: http://18.188.194.159/login.php?message=Standard%20Users%20May%20Not%20Access%20This%20Page");     // Re-direct the user to the login screen as they need to login.
  }

?>
<html lang="en">
<head>
  <title>Business Insights - Branch</title>
          ...
          <div class="col-xl">
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                ...
                <div class="row mt-4">
                  <div class="col-xl">
                    <div class="h5">Award Totals by State</div>
                  </div>
                </div>
                <!-- end users table -->
  ...
  <script type="text/javascript">
    ...
    function drawTable() {
      ...
      for (var i = 0; i < obj.length; i++) {
        var row =  [obj[i].branch,
                    obj[i].state,
                    Number(obj[i].awardCount),
                    Number(obj[i].avgSalary),
                    Number(obj[i].avgTimeWithCompany)];
        rowData.push(row);
      }

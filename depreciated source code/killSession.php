<?php
  ...
  header("Location: http://18.188.194.159/login.php?message=You%20Have%20Been%20Successfully%20Logged%20Out"); // Re-direct the user to the login screen as they need to login.
?>

<?php
  ...
  if(!(isset($_SESSION['user']))){ // If there was a session in progress this global value would not be null. If it is null...
    ...
    header("Location: http://18.188.194.159/award-hub/login-system/login.php?message=Login%20To%20Access%20Page");     // Re-direct the user to the login screen as they need to login.
  }
?>

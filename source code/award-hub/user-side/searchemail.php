...
<head>
    ...
    <title>Search For Employee Email</title>
    ...
    <div class="container">
        <div class="row justify-content-center"> <!-- Makes page content a little more centered now -->
            ...
            <div class ="col-sm-12 page-content">
                ...
                <!--
                  * Credit:
                  * https://stackoverflow.com/questions/13231254/how-to-redirect-to-another-page-after-if-condition-is-satisfied-in-php
                  * https://stackoverflow.com/questions/9321071/php-pass-data-with-redirect
                -->
                <div class="container">
                    <div class="card">
